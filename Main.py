...
# FVG-like signal: Agar Price 200 EMA ke pass se reject ho raha hai aur volume spike hai
...
if is_bullish_sweep:
    ...
    signal, color = "WAITING FOR LIQUIDITY SWEEP", "#f59e0b"
...
<div style="background: #1e293b; padding: 20px; border-radius: 12px; border-left: 5px solid {color};">
    ...
    {f'<p style="color:red;"><b>SL:</b> {sl:.2f}</p><p style="color:green;"><b>TP:</b> {tp:.2f}</p>' if "INSTITUTIONAL" in signal else ''}
