...
# SABSE SAFE TARIKA: Ek hi baar check karo aur agar issue ho toh exit kar jao
if data.empty or len(data) < 100:
    st.warning("⚠️ Market band hai ya data nahi mil raha. Monday ko check karein.")
    st.stop() # Ye code ko yahan rok dega, aage badhne hi nahi dega

# Agar yahan tak pahunche, matlab data safe hai
data = data.dropna()
